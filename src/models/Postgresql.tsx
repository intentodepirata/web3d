...
export const Postgresql = ({ position, rotation }) => {
  const { nodes, materials } = useGLTF("models/postgresql.glb");
...
useGLTF.preload("models/postgresql.glb");
